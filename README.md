...
01_introduction_and_goals.md	Objetivo general del ERP y sus 6 módulos, requisitos de negocio del módulo de Compras y metas de calidad.
02_architecture_constraints.md	Tecnologías escogidas (React, Spring Boot, PostgreSQL) y restricciones del proyecto.
03_system_scope_and_context.md	Contexto de negocio con los 6 roles de usuario y el diagrama C1.
05_building_block_view.md	Diagrama de contenedores (C2) y modelo de datos (MER) del módulo de Compras.
06_runtime_view.md	Diagrama de secuencia del escenario "Generar Orden de Compra".
07_deployment_view.md	Cómo se desplegaría el sistema (Docker: Nginx + API + PostgreSQL).
10_glossary.md	Glosario de términos del dominio del ERP.
...
Todas las imágenes de los diagramas están en la carpeta images, y son referenciadas desde los archivos .md de arriba.
